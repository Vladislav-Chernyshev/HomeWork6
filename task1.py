...
el, dif, col_el = map(int, input().split())


def arithmetic_progression(element: int, difference: int, col_element: int) -> list:
    result = [element + i * difference for i in range(col_element)]
    return result


print(arithmetic_progression(el, dif, col_el))
