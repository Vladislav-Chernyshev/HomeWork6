...
def index_value_list(lst: list, first_el_range: int, last_el_range: int) -> list:
    result = [(ind, value) for ind, value in enumerate(lst) if first_el_range <= value <= last_el_range]
    return result


print(index_value_list(lst1, 0, 6))
